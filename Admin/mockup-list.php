...
$page_title = 'Mockup Product List';
require 'header.php';
?>
  ...
  <div class="container-fluid">
    <div class="page-header d-flex justify-content-between align-items-center mb-4">
      <h3 class="page-title mb-0">
        ...
        </span> Mockup Product List
      </h3>
      <a href="add-mockup.php" class="btn btn-primary">
    ...
    <form method="get" class="mb-4 row gx-2 gy-2 align-items-center">
      ...
      <div class="col-3">
        <select name="category" class="form-control">
          ...
          <?php
          $catRes = mysqli_query($conn, "SELECT id, category_name FROM mockup_category ORDER BY category_name ASC");
    ...
    <div class="row">
      ...
      $sql = "SELECT p.*, c.category_name
              FROM mockup_products p
              LEFT JOIN mockup_category c ON p.category_id = c.id";
            ...
            <div class="card-body d-flex flex-column">
              ...
              <div class="mt-auto">
                ...
                <div class="d-flex gap-2">
                  <a href="edit-mockup-product.php?id=<?php echo $row['id']; ?>" class="btn btn-dark mb-0">
      ...
      ?>
        <div class="col-12 text-center py-5">
          <h5 class="text-muted">No mockup products found.</h5>
          <a href="add-mockup.php" class="btn btn-primary mt-3">Add Product</a>
        </div>
      <?php endif; ?>
...
function confirmDelete(id) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      fetch('delete_mockup_product.php', {
        method: 'POST',
