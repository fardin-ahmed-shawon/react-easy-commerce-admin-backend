...
function exportToExcel() {
    ...
    // Since there is no action column, we can directly export the cloned table
    var wb = XLSX.utils.book_new();
    var ws = XLSX.utils.table_to_sheet(cloneTable);
    XLSX.utils.book_append_sheet(wb, ws, "All_Expenses");

    XLSX.writeFile(wb, 'All_Expenses_<?php echo date('Y-m-d'); ?>.xlsx');
}
</script>
