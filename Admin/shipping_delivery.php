...
$page_title = 'Shipping & Delivery'; // Set the page title
?>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
    ...
    if (!empty($description)) {
        ...
        $product_added_status = "Please fill in the Shipping & Delivery content.";
    }
}
?>
...
<div class="content-wrapper">
            ...
            <div class="row">
              <div class="form-container">
                <h1 class="text-center">Write Shipping & Delivery</h1>
                <div class="content">
                    <!-- Product Add form -->
