...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO blogs (blog_title, blog_description, blog_img, created_at)
              VALUES ('$blog_title', '$blog_description', '$blog_img', '$created_at')";
...
<div class="content-wrapper py-5">
  <div class="container">
    <div class="page-card">
      ...
      <form action="" method="POST" enctype="multipart/form-data" id="addBlogForm">
        <div class="row g-4">
          <!-- Left Column -->
          <div class="col-lg-8">
            <div class="mb-3">
            ...
            <div class="mt-4">
              <button type="submit" class="btn btn-primary">
                <i class="bx bx-save me-1"></i> Upload Blog
              </button>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="upload-box">
              <label for="blog_img">Attach Blog Image *</label>
