...
$page_title = 'Create Customized Category';
require 'header.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['insert_category'])) {
        ...
        // Ensure unique slug
        $check_slug = $conn->prepare("SELECT * FROM customized_category WHERE category_slug = ?");
        ...
        $stmt = $conn->prepare("INSERT INTO customized_category (category_name, category_slug) VALUES (?, ?)");
    ...
    if (isset($_POST['update_category'])) {
        ...
        $stmt = $conn->prepare("UPDATE customized_category SET category_name=?, category_slug=? WHERE id=?");
...
if (isset($_GET['delete'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM customized_category WHERE id = ?");
...
$categories = $conn->query("SELECT * FROM customized_category ORDER BY id DESC");
?>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card shadow p-3">
                ...
                if (isset($_GET['edit'])) {
                    $id = intval($_GET['edit']);
                    $result = $conn->query("SELECT * FROM customized_category WHERE id=$id");
                ...
                <form method="post">
                    ...
                    <div class="d-grid">
                        <?php if (isset($_GET['edit'])): ?>
                            ...
                            <a href="create_customized_category.php" class="btn btn-secondary mt-2">Cancel</a>
                        <?php else: ?>
        ...
        <div class="col-md-8">
            <div class="card shadow p-3">
                <h5 class="card-title text-center mb-3">All Categories</h5>
