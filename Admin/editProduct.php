                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                      <div class="user-details full-input-box">
                        ...
                        <div class="upload-box">
                          <label for="blog_img">Attach Primary Image*</label>
                          <small>(Recommended size: 1000 x 1000)</small>
                          <input type="file" name="product_img1" id="file" class="form-control" class="inputfile">
                          <img id="previewImage" src="<?php echo !empty($product['product_img1']) ? '../uploads/'.$product['product_img1'] : ''; ?>" class="img-preview <?php echo !empty($product['product_img1']) ? '' : 'd-none'; ?>" alt="Preview">
                        </div>
                        ...
                        <div class="upload-box">
                          <label for="blog_img">Attach Image 2</label>
                          <small>(Recommended size: 1000 x 1000)</small>
                          <input type="file" name="product_img2" id="file" class="form-control" class="inputfile">
                          <img id="previewImage" src="<?php echo !empty($product['product_img2']) ? '../uploads/'.$product['product_img2'] : ''; ?>" class="img-preview <?php echo !empty($product['product_img2']) ? '' : 'd-none'; ?>" alt="Preview">
                        </div>
                        ...
                        <div class="upload-box">
                          <label for="blog_img">Attach Image 3</label>
                          <small>(Recommended size: 1000 x 1000)</small>
                          <input type="file" name="product_img3" id="file" class="form-control" class="inputfile">
                          <img id="previewImage" src="<?php echo !empty($product['product_img3']) ? '../uploads/'.$product['product_img3'] : ''; ?>" class="img-preview <?php echo !empty($product['product_img3']) ? '' : 'd-none'; ?>" alt="Preview">
                        </div>
                        ...
                        <div class="upload-box">
                          <label for="blog_img">Attach Image 4</label>
                          <small>(Recommended size: 1000 x 1000)</small>
                          <input type="file" name="product_img4" id="file" class="form-control" class="inputfile">
                          <img id="previewImage" src="<?php echo !empty($product['product_img4']) ? '../uploads/'.$product['product_img4'] : ''; ?>" class="img-preview <?php echo !empty($product['product_img4']) ? '' : 'd-none'; ?>" alt="Preview">
                        </div>
